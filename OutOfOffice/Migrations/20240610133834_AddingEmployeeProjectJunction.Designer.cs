...
namespace OutOfOffice.Migrations
{
    ...
    [Migration("20240610133834_AddingEmployeeProjectJunction")]
    partial class AddingEmployeeProjectJunction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutOfOffice.DAL.Models.EmployeeProjectJunction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EmployeeProjectJunctions");
                });
            ...
            modelBuilder.Entity("OutOfOffice.DAL.Models.EmployeeProjectJunction", b =>
                {
                    b.HasOne("OutOfOffice.DAL.Models.Employee", "Employee")
                        .WithMany("EmployeeProjectJunctions")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("OutOfOffice.DAL.Models.Project", "Project")
                        .WithMany("EmployeeProjectJunctions")
            ...
            modelBuilder.Entity("OutOfOffice.DAL.Models.Project", b =>
                {
                    b.Navigation("EmployeeProjectJunctions");
                });
